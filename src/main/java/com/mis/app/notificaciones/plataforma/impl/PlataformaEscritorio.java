...
/**
 * Implementación de plataforma de notificación para aplicaciones de escritorio.
 * Proporciona funcionalidad específica para mostrar notificaciones en entornos de escritorio.
 */
@Component
public class PlataformaEscritorio implements PlataformaNotificacion {
	
    /**
     * Muestra una notificación de escritorio con formato específico según el tipo.
     * 
     ...
     */
    @Override
    public String mostrar(String titulo, String mensaje, TipoNotificacion tipo) {
    		// implementacion para cada tipo de notificacion
     		return switch (tipo) {
     		case MENSAJE -> 
